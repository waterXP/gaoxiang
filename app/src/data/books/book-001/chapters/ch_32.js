export default [
  {
    page: '472,473,474,475,476,477,478,479,480,481,482,483,484,485,486',
    type: "普通",
    content: [
      "h2:第三十二章 项目管理工具和技术汇总",
      {
        ...
        rows: [
          ...
          [
            "im:核查表",
            "又称计数表，用于合理排列各种事项，以便有效地收集关于潜在质量问题的有用数据。在开展检查以识别缺陷时，用核查表收集属性数据就特别方便",
            "控制质量",
          ],
          [
            "im:核对单",
          ...
          [
            "im:备选方案分析",
            "一种对已识别的可选方案进行评估的技术，用来决定选择哪种方案或使用何种方法来执行项目工作。备选方案分析有助于提供在定义的制约因素范围内执行项目活动的最佳方案。",
            "监控项目工作、实施整体变更控制、规划范围管理、定义范围、规划进度管理、估算活动持续时间、规划成本管理、估算成本、管理质量、估算活动资源、控制资源、规划风险应对、监督干系人参与",
          ],
          [
            "im:其他风险参数评估",
            "为了方便未来分析和行动，在对单个项目风险进行优先级排序时，项目团队可能考虑(除概率和影响以外的)其他风险特征。此类特征可能包括(但不限于):紧迫性、邻近性、潜伏期、可管理性、可控性、可监测性、连通性、战略影响力、密切度。",
            "实施定性风险分析",
          ],
          [
            "im:假设条件和制约因素分析",
            "每个项目及其项目管理计划的构思和开发都基于一系列的假设条件，并受一系列制约因素的限制。开展假设条件和制约因素分析，来探索假设条件和制约因素的有效性，确定其中哪些会引发项目风险。从假设条件的不准确、不稳定、不一致或不完整，可以识别出威胁，通过清除或放松会影响项目或过程执行的制约因素，可以创造出机会。",
            "识别风险、规划干系人参与",
          ],
          [
            "im:质量成本",
            "与项目有关的质量成本包含以下一种或多种成本1预防成本。预防特定项目的产品、可交付成果或服务质量低劣所带来的成本。2评估成本。评估、测量、审计和测试特定项目的产品、可交付成果或服务所带来的成本。3失败成本(内部/外部)。因产品、可交付成果或服务与干系人需求或期望不一致而导致的成本。",
            "估算成本、规划质量管理",
          ],
          [
            "im:成本效益分析",
          ...
          [
            "im:迭代燃尽图",
            "用于追踪迭代未完项中尚待完成的工作。它基于迭代规划中确定的工作，分析与理想燃尽图的偏差。可使用预测趋势线来预测迭代结束时可能出现的偏差，以及在迭代期间应该采取的合理行动。在燃尽图中，先用对角线表示理想的燃尽情况，再每天画出实际剩余工作，最后基于剩余工作计算出趋势线以预测完成情况",
            "控制进度",
          ],
          [
            "im:自制或外购分析",
          ...
          [
            "im:回归分析",
            "通过考察一系列输入变量及其对应的输出结果，建立数学或统计关系的一种分析技术，可以用来推断未来的绩效",
            "结束项目或阶段",
          ],
          [
            "im:储备分析",
            "一种分析技术，用来明确项目管理计划各组成部分的基本特征及其相互关系，从而为项目的工期、预算、成本估算或资金需求设定储备。有应急储备和管理储备。",
          ...
          [
            "im:根本原因分析",
            "确定引起偏差、缺陷或风险的根本原因的一种分析技术，一项根本原因可能引起多项偏差、缺陷或风",
          ...
          [
            "im:模拟",
            "一种分析技术，通过建立模型，来综合分析各种不确定性因素，评估这些因素对目标的，潜在影响。蒙特卡洛分析",
            "制定进度计划、实施定量风险分析",
          ],
          [
            "im:干系人分析",
          ...
          [
            "im:SWOT 分析",
            "对项目的优势、劣势、机会和威胁进行逐个检查。找出组织优势可能为项目带来的机会和组织劣势可能造成的威胁。还可以分析组织优势能在多大程度上克服威胁，组织劣势是否会妨碍机会的产生。",
            "识别风险",
          ],
          [
            "im:技术绩效分析",
          ...
          [
            "im:趋势分析",
            "根据历史数据并利用数学模型，预测未来结果的-种分析技术。旨在审查项目绩效随时间的变化情况，以判断绩效是正在改善还是正在恶化。",
          ...
          [
            "im:控制图",
            "用于确定一个过程是否稳定，或者是否具有可预测的绩效。规格上限和下限是根据要求制定的，反映了可允许的最大值和最小值。控制图可用于监测各种类型的输出变量。控制图常用来跟踪批量生产中的重复性活动，但也可用来监测成本与进度偏差、产量、范围变更频率或其他管理工作成果，以便帮助确定项目管理过程是否受控。",
            "控制质量",
          ],
          [
            "im:流程图",
            "流程图也称过程图，用来显示将一个或多个输入转化成一个或多个输出的过程中，所需步骤顺序和可能分支。可帮助改进过程并识别可能出现质量缺陷或可以纳入质量检查的地方。",
            "规划质量管理、管理质量",
          ],
          [
            "im:层级图",
            "层级型是数据表现中用于记录和阐明团队成员角色与职责的一种格式，它可采用传统的组织结构图，自下而上地显示各种职位及其相互关系。",
            "规划资源管理(正文是层级型)、实施定性风险分析(正文是层级图)",
          ],
          [
            "im:直方图",
            "一种展示数字数据的条形图。可展示每个可交付成果的缺陷数量、缺陷成因排列、各个过程的不合规次数，或项目或产品缺陷的其他表现形式。",
            "管理质量、控制质量",
          ],
          [
            "im:逻辑数据模型",
            "逻辑数据模型把组织数据可视化，用业务语言加以描述，不依赖任何特定技术。逻辑数据模型可用于识别会出现数据完整性或其他问题的地方。",
            "规划质量管理",
          ],
          [
            "im:矩阵图",
            "矩阵图在行列交叉的位置展示因素、原因和目标之间的强弱关系。根据可用来比较因素的数量，项目经理可使用不同形状的矩阵图，如L型、T型、Y型、X型、C型和屋顶型矩阵。",
            "规划质量管理、管理质量",
          ],
          [
            "im:职责分配矩阵",
          ...
          [
            "im:思维导图",
            "把从头脑风暴中获得的创意整合成一张图的技术，用以反映创意之间的共性与差异，激发新创意。",
            "收集需求、规划质量管理、规划干系人参与",
          ],
          [
            "im:概率和影响矩阵",
          ...
          [
            "im:干系人参与度评估矩阵",
            "将当前与期望的干系人参与程度进行比较的一种矩阵。",
            "规划沟通管理、监督沟通、规划干系人参与、监督干系人参与",
          ],
          [
            "im:干系人映射分析和表现",
            "干系人映射分析和表现是一种利用不同方法对干系人进行分类的方法。常见的分类方法包括(1)权力利益方格、权力影响方格，或作用影响方格(2)干系人立方体(3)凸显模型(4)影响方向(5)优先级排序",
            "识别干系人",
          ],
          [
            "im:文本型",
          ...
          [
            "im:反馈",
            "反馈是关于沟通、可交付成果或情况的反应信息。反馈支持项目经理和团队及所有其他项目干系人之间的互动沟通。",
            "管理沟通、监督干系人参与",
          ],
          [
            "im:沟通胜任力",
          ...
          [
            "im:非口头技能",
            "通过示意、语调和面部表情等适当的肢体语言来表达意思。镜像模仿和眼神交流也是重要的技能。团队成员应该知道如何通过说什么和不说什么来表达自己的想法。",
            "管理沟通",
          ],
          [
            "im:演示",
            "演示是信息和文档的正式交付。向干系人明确、有效地演示项目的信息，主要包括:1向干系人报告项目进度和信息更新;2提供背景信息以支持决策制定;3提供关于项目及其目标的通用信息，以提升项目工作和项目团队的形象;4提供具体信息，以提升对项目工作和目标的理解和支持力度等。",
            "管理沟通、监督干系人参与",
          ],
          [
            "im:积极倾听",
          ...
          [
            "im:沟通风格评估",
            "规划沟通活动时，用于评估沟通风格并识别偏好的沟通方法、形式和内容的一种技术。常用于不支持项目的干系人。可以先开展于系人参与度评估，再开展沟通风格评估。",
            "规划沟通管理",
          ],
          [
            "im:冲突管理",
            "采用特定方式对冲突进行管理。撤退/回避、缓和/包容、妥协/调解、强迫/命令、合作/解决问题。",
          ...
          [
            "im:制定决策",
            "这里的决策包括谈判能力以及影响组织与项目管理团队的能力，而不是决策工具集所描述的一系列工具。进行有效决策需要:(1)着眼于所要达到的目标;(2)遵循决策流程;(3)研究环境因素;(4)分析可用信息;(5)激发团队创造力;(6)理解风险",
            "管理团队",
          ],
          [
            "im:情商",
          ...
          [
            "im:引导",
            "在研讨会和座谈会中使用引导技能来协调具有不同期望或不同专业知识的关键干系人。",
            "定义范围、实施定性风险分析、实施定量风险分析、规划风险应对",
          ],
          [
            "im:谈判",
            "谈判是为达成协议而进行的讨论，它用于获得支持或达成关于支持项目工作或成果的协议，并解决团队内部或团队与其他干系人之间的冲突。",
          ...
          [
            "im:政策意识",
            "政策意识有助于理解组织战略，理解谁能行使权力和施加影响，以及培养与这些干系人沟通的能力。指对正式和非正式权力关系的认知，以及在这些关系中工作的意愿。",
            "管理项目知识、规划沟通管理、管理沟通、管理干系人参与、监督干系人参与",
          ],
          [
            "im:团队建设",
            "团队建设是指通过举办各种活动，强化团队的社交关系，打造积极合作的工作环境",
            "建设团队",
          ],
          [
            "im:广告",
          ...
          [
            "im:类比估算",
            "使用相似活动或项目的历史数据，来估算当前活动或项目的持续时间或成本的技术。类比估算通常成本、估算活动资源",
            "估算活动持续时间、估算成本较低、耗时较少，但准确性也较低",
          ],
          [
            "im:审计",
          ...
          ["im:索赔管理", "对合同索赔进行处理、裁决和沟通的过程", "控制采购"],
          [
            "im:集中办公",
            "为改善沟通和工作关系，提高工作效率，而让项目团队成员的工作地点彼此靠近的一种组织布局策略。",
            "建设团队",
          ],
          [
            "im:沟通方法",
            "在项目干系人之间传递信息的系统化的程序、技术或过程。互动沟通、推式沟通、拉式沟通。",
            "规划沟通管理、管理沟通",
          ],
          [
            "im:沟通模型",
          ...
          [
            "im:沟通需求分析",
            "种分析技术，通过访谈、研讨会或借鉴以往项目经验教训等方式，来确定项目干系人对信息的需求。",
            "规划沟通管理",
          ],
          [
            "im:沟通技术",
          ...
          [
            "im:资金限制平衡",
            "应该根据对项目资金的限制来平衡资金支出，如果发现资金限制与计划支出之间存在差异，则可能需要调整工作的进度计划，以平衡资金的支出水平，例如可通过在项目进度计划中添加强制日期来实现。",
            "制定预算",
          ],
          [
            "im:历史信息审核",
          ...
          [
            "im:个人和团队评估",
            "能让项目经理和项目团队洞察成员的优势和劣势。这些工具可帮助项目经理评估团队成员的偏好和愿望、团队成员如何处理和整理信息、如何制定决策，以及团队成员如何与他人打交道。有各种可用的工具，如态度调查、专项评估、结构化访谈、能力测试及焦点小组。有利于增进团队成员间的理解、信任、承诺和沟通，在整个项目期间不断提高团队成效。",
            "建设团队",
          ],
          [
            "im:检查",
          ...
          [
            "im:紧前关系绘图法",
            "前导图法，是创建进度模型的一种技术，使用方框或者长方形（被称作节点）代表活动，节点之间用箭头连接，以显示节点之间的逻辑关系。这种网络图也被称作单代号网络图",
            "排列活动顺序",
          ],
          [
            "im:会议",
            "指有组织、有领导、有目的的议事活动，它是在限定的时间和地点，按照一定的程序进行的。它可以是面对面或虚拟会议，正式或非正式会议。参会者可以包括项目团队成员和其他合适的项目干系人;会议的类型包括（但不限于）用户小组会议和用户审查会议。",
          ...
          [
            "im:参数估算",
            "基于历史数据和项目参数，使用某种算法来计算成本或持续时间的一种估算技术。参数估算的准确性取决于参数模型的成熟度和基础数据的可靠性。",
            "估算活动持续时间、估算成本、估算活动资源",
          ],
          [
            "im:预分派",
          ...
          [
            "im:项目管理信息系统",
            "即PMIS，由收集、整合和传播项目管理过程成果的工具和技术所组成的信息系统。",
          ...
          [
            "im:原型法",
            "在实际制造预期产品之前，先造出其实用模型，并据此征求对需求的早期反馈的一种方法。",
            "收集需求",
          ],
          [
            "im:质量改进方法",
          ...
          [
            "im:资源优化",
            "资源优化技术是根据资源供需情况来调整进度模型的技术。资源优化用于调整活动的开始和完成日期，以调整计划使用的资源，使其等于或少于可用的资源，包括：资源平衡，资源平滑",
            "制定进度计划、控制进度",
          ],
          [
            "im:不确定性表现方式",
            "要开展定量风险分析，就需要建立能反映单个项目风险和其他不确定性来源的定量风险分析模型，并为之提供输入。如果活动的持续时间、成本或资源需求是不确定的，就可以在模型中用概率分布来表示其数值的可能区间。概率分布可能有多种形式，最常用的有三角分布、正态分布、对数正态分布、贝塔分布、均匀分布或离散分布。应该谨慎选择用于表示活动数值的可能区间的概率分布形式。单个项目风险可以用概率分布图表示，或者，也可以作为概率分支包括在定量分析模型中。其他不确定性来源也可用概率分支来表示，以描述贯穿项目的其他路径。",
            "实施定量风险分析",
          ],
          [
            "im:滚动式规划",
          ...
          [
            "im:进度压缩",
            "在不缩小项目范围的前提下缩短进度工期的技术。包括：赶工、快速跟进。",
            "制定进度计划、控制进度、制定进度计划",
          ],
          [
            "im:风险分类",
            "项目风险可依据风险来源、受影响的项目领域，以及其他实用类别来分类；风险还可以根据共同根本原因进行分类。应该在风险管理计划中规定可用于项目的风险分类方法。",
            "实施定性风险分析",
          ],
          [
            "im:进度网络分析",
            "进度网络分析是创建项目进度模型的一种综合技",
            "制定进度计划",
          ],
          [
            "im:供方选择分析",
          ...
          [
            "im:整体项目风险应对策略",
            "风险应对措施的规划和实施不应只针对单个项目风险，还应针对整体项目风险。用于应对单个项目风险的策略也适用于整体项目风险：规避、开拓、转移或分享、减轻或提高、接受",
            "规划风险应对",
          ],
          [
            "im:威胁应对策略",
          ...
          [
            "im:三点估算",
            "种估算技术。当单个活动的成本或持续时间估算不易确定时，取其乐观估算、悲观估算和最可能估算的平均值或加权平均值。",
            "估算活动持续时间、估算成本",
          ],
          [
            "im:完工尚需绩效指数",
            "为了实现特定的管理目标，剩余资源的使用必须达到的成本绩效指标，是完成剩余工作所需成本与剩余预算之比。",
            "控制成本",
          ],
          [
            "im:培训",
          ...
          [
            "im:虚拟团队",
            "虚拟团队可定义为具有共同目标，在完成角色任务的过程中很少或没有时间面对面工作的一群人。现代沟通技术（如电子邮件电话会议、社交媒体、网络会议和视频会议等）使虚拟团队成为可行",
            "获取资源、建设团队",
          ],
          [
            "im:信息管理",
